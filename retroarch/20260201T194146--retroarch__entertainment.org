...
* tangle
#+begin_src elisp
(let* ((webdav-url "https://dav.jianguoyun.com/dav/")
       (secret (car (auth-source-search :host webdav-url :max 1)))
       (webdav-username (plist-get secret :user))
       (webdav-password (auth-info-password secret))
