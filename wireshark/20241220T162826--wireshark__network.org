...
function print_uri_stats()
  ...
  for uri, stats in pairs(uri_stats) do
    ...
    print(string.format("  Minimum request time: %.3f sec", stats.min_duration))
    print(string.format("  Maximum request time: %.3f sec", stats.max_duration))
...
if %errorlevel% equ 0 (
    ...
    set tshark_path=tshark
    set wireshark_path=wireshark
    set mergecap_path=mergecap
)
#+end_src
