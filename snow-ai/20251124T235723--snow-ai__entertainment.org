...
#+begin_src json :tangle (zr-org-by-tangle-dir "default.json")
{
  "snowcfg": {
    ...
    "advancedModel": "$group/claude-sonnet-4-5-20250929",
    "basicModel": "$group/claude-sonnet-4-5-20250929",
    "maxContextTokens": 200000,
    "maxTokens": 32000,
    "compactModel": {
      "modelName": "$group/claude-haiku-4-5-20251001"
    }
  }
}
#+end_src
...
*** 88code
#+header: :var host=(plist-get keys :host-88)
#+header: :var key=(plist-get keys :88)
#+begin_src json :tangle (zr-org-by-tangle-dir "88code.json")
<<codex>>
#+end_src

*** claude-code
#+header: :var group="ccc"
#+header: :var key=(plist-get keys :ccc)
