             ...
             (lambda (url key basic compact advance extra)
               (json-serialize
                `((snowcfg . ,(append `((baseUrl . ,url)
                  ...
                  (proxy . ,proxy))))))
    (org-babel-tangle))
  (let ((default-directory (expand-file-name "_tangle")))
    (copy-file "config.json" "profiles/default.json" t))
...
#+header: :var basic="cc/claude-haiku-4-5-20251001"
#+header: :var compact="cc/claude-haiku-4-5-20251001"
#+header: :var advance="cc/claude-sonnet-4-5-20250929"
#+name: gen-cc
#+begin_src elisp
(gen-profile (if (bound-and-true-p url) url
               (format "https://%s/anthropic/v1" host))
...
#+header: :var key=(plist-get keys :gmn)
#+header: :var basic="gmn/gemini-2.5-pro"
#+header: :var compact="gmn/gemini-2.5-flash"
#+header: :var advance="gmn/gemini-3-pro-preview"
#+name: gen-gmn
#+begin_src elisp
(gen-profile (if (bound-and-true-p url) url
...
*** 88code
#+begin_src json :tangle (zr-org-by-tangle-dir "88code.json")
<<gen-cx(host=(plist-get keys :host-88),key=(plist-get keys :88))>>
#+end_src

*** claude-code
#+begin_src json :tangle (zr-org-by-tangle-dir "claude.json")
<<gen-cc(key=(plist-get keys :ccc),basic="ccc/claude-haiku-4-5-20251001",compact="ccc/claude-haiku-4-5-20251001",advance="ccc/claude-sonnet-4-5-20250929")>>
#+end_src
