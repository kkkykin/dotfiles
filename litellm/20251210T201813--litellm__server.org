       ...
       (let* ((models (ensure-list (or (alist-get 'model params) name)))
         ...
         (dolist (m (mapcar (lambda (x) (format x name)) models))
           (let* ((k-key nil)
                  ...
                  (extra-hdr nil))
             (pcase m
               ("t" (setq model-id (concat "openai/" name)))
               ((rx bos "cx/")
               ...
               ((rx bos "gmn/")
                (setq model-id (if (string= "gmn/t" m)
                                   (concat "gemini/" name)
                                 (replace-regexp-in-string "^gmn/" "" m))
                      k-key "apikey_g"
                      mode :null
                      k-base 'api_base_g))
               ((rx "embed")
               ...
               (_ (setq model-id (concat "openai/" name))))
             (let* ((this-model
                     (put* params
                           (delq nil
               ...
               (dolist (base bases)
                 (let* ((base-model
                         (put* (drop-keys this-model '(api_base api_base_a api_base_o api_base_g))
...
| gpt-5.1                       |                                     | t     |                                     |
| gpt-5.1-codex                 |                                     | cx/t  |                                     |
| gpt-5.1-codex-max             |                                     | cx/t  |                                     |
| gpt-5.2                       |                                     | cx/t  |                                     |
| gpt-5.2-codex                 |                                     | cx/t  |                                     |
| gemini-2.5-flash              |                                     | gmn/t |                                     |
| gemini-2.5-pro                |                                     | gmn/t |                                     |
| gemini-3-flash                |                                     | gmn/t |                                     |
| gemini-3-pro-image            |                                     | gmn/t |                                     |
