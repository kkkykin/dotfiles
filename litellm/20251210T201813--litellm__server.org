...
(cl-letf (((symbol-function 'format-models)
                         ...
                         (mapc
                          (lambda (key)
                            (let ((new (append `( :api_key ,key
                                                  ...
                                                  :api_base_o :null)
                                               new-base)))
                              (unless (plist-member new :tags)
                                (plist-put new :tags ["default"]))
  ...
  (let* ((zr-local-pls (plstore-open (expand-file-name "litellm.pls" zr-secrets-dir)))
         ...
         (general-settings `((forward_client_headers_to_llm_api . t)
...
* models
#+name: models-tbl
| name                          | zhongruan | pangil            | kkkyyx     | dabuliu           | bohe                  | HenryXiaoYang | bytebender         | jason_wong1 | anyrouter | huan                 | snow | 88code | ouyangqiqi              | iflow | modelscope                          | sc0152                                    | linuxdo |
|-------------------------------+-----------+-------------------+------------+-------------------+-----------------------+---------------+--------------------+-------------+-----------+----------------------+------+--------+-------------------------+-------+-------------------------------------+-------------------------------------------+---------|
| claude-opus-4-5               |           |                   |            |                   | %s-thinking           |               | claude-4.5-opus    |             |           |                      |      |        |                         |       |                                     |                                           | t       |
| claude-opus-4-5-20251101      |           | t                 |            |                   |                       | ant/t         |                    | ant/t       | ant/t     |                      |      |        |                         |       |                                     |                                           | t       |
| claude-sonnet-4-5             |           | '("t" "%s-think") |            |                   | t                     |               | t                  |             |           |                      |      |        | t                       |       |                                     | claude-sonnet-4.5 [渠道id:33][輸出3k上限] | t       |
| claude-4.5-sonnet             |           | '("t" "%s-think") | cursor2-%s | '("t" "%s-think") |                       |               | t                  |             |           |                      |      |        |                         |       |                                     |                                           | t       |
| claude-sonnet-4-5-20250929    |           | t                 |            |                   |                       | ant/t         | t                  | ant/t       | ant/t     |                      |      |        |                         |       |                                     |                                           | t       |
| claude-4-sonnet               |           | '("t" "%s-think") | cursor2-%s | '("t" "%s-think") |                       |               | '("t" "ant/%s-cc") |             |           |                      |      |        | t                       |       |                                     |                                           | t       |
| claude-sonnet-4-20250514      |           |                   |            |                   |                       | ant/t         |                    | ant/t       | ant/t     |                      |      |        |                         |       |                                     |                                           | t       |
| claude-haiku-4-5-20251001     |           | t                 |            |                   |                       | ant/t         |                    | ant/t       | ant/t     |                      |      |        |                         |       |                                     |                                           | t       |
| claude-3-5-haiku-20241022     |           |                   |            |                   |                       |               |                    | ant/t       | ant/t     |                      |      |        |                         |       |                                     |                                           | t       |
| gpt-5                         |           |                   | cursor2-%s |                   |                       |               |                    |             |           |                      | t    |        |                         |       |                                     |                                           | t       |
| gpt-5-codex                   |           |                   | cursor2-%s |                   |                       |               |                    |             | ant/t     |                      | t    | t      |                         |       |                                     |                                           | t       |
| gpt-5.1                       | t         |                   |            |                   |                       |               | t                  |             |           |                      | t    | t      |                         |       |                                     |                                           | t       |
| gpt-5.1-codex                 | t         | t                 |            |                   |                       |               |                    |             |           |                      | t    | t      |                         |       |                                     |                                           |         |
| gpt-5.1-codex-max             |           |                   |            |                   |                       |               |                    |             |           |                      | t    | t      |                         |       |                                     |                                           | t       |
| gpt-5.2                       | t         |                   |            |                   |                       |               |                    |             |           |                      |      |        |                         |       |                                     |                                           |         |
| gemini-2.5-pro                |           | t                 |            |                   | %s-1m                 |               | t                  |             | ant/t     |                      |      |        | '("t" "hyb-Optimal/%s") |       |                                     |                                           | t       |
| gemini-3-pro                  |           | %s-coding-32k     |            |                   | '("%s-low" "%s-high") |               | %s-preview         |             |           |                      |      |        | gemini-pro-latest       |       |                                     |                                           | t       |
| grok-4.1                      |           |                   |            |                   |                       |               |                    |             |           | '("t" "%s-thinking") |      |        | '("t" "%s-thinking")    |       |                                     |                                           | t       |
