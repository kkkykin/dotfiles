...
set "WEBVIEW2_ADDITIONAL_BROWSER_ARGUMENTS=--proxy-server=%local_proxy%"
...
set "all_proxy=http://%local_proxy%"
...
:END:
#+name: profile_main
#+header: :var local_proxy=(let ((proxy (gethash "proxy" (zr-sops-parse-json "../global.json")))) (format "%s:%d" (gethash "host" proxy) (gethash "port" proxy)))
...
** Debug-Firewall
:PROPERTIES:
:CUSTOM_ID: 7caa8cb2-cf9f-4e96-90a7-fa3a66ec04a0
:END:
