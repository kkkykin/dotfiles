...
(let* ((pre-rules '(((action . "sniff")
                    ...
                    ((ip_is_private . t)
                     ...
                     (rule_set . ["geosite-geolocation-cn"
                                  "geosite-cn"
                                  "geoip-cn"]))))
       (mode-rules `(((clash_mode . "cf-direct")
                      (outbound . "direct")
...
* bounds
:PROPERTIES:
:header-args:elisp: :var wg-clients=(cdr (plstore-get zr-local-pls "wg")) wg-ep='((name . "sb-wg") (tag . "wg-ep") (type . "wireguard")) ts-ep='((tag . "ts-ep") (type . "tailscale")) obds='(((tag . "direct") (type . "direct"))) ibds='() ep='() conf='()
:END:
** client
