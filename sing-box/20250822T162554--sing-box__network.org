...
#+header: :var cache_path=(expand-file-name "cache.db" zr-org-tangle-default-dir)
...
#+begin_src json :tangle (zr-org-by-tangle-dir "_500-main.json") :mkdirp t
{
  ...
  "route": {
    ...
    "rule_set": [
      ...
      {
        "path": "$rule_sets_dir/tls-record-frag.srs",
        "tag": "tls-record-frag-rules",
        "type": "local"
      },
      {
      ...
      },
      {
        ...
        "type": "remote",
        "url": "$jsdelivr/gh/SagerNet/sing-geosite@rule-set/geosite-telegram.srs"
      },
      {
        "download_detour": "s[direct]",
...
(let* ((final-dns "ld-neo")
  ...
  (json-serialize
   `((dns . ((final . ,final-dns)
             ...
             (rules . ,(vconcat pre-dns-client-rules dns-rules))))
