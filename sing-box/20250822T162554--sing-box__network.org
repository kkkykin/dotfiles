...
:header-args:json: :var s0_obfs_pass=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :obfs-pass)) 1 -1)
:header-args:json+: :var s0_ip=(plist-get (cdr (plstore-get zr-local-pls "vps0")) (if (zr-net-has-public-ipv6-addr-p) :ipv6 :ip))
:header-args:json+: :var s0_user_pass=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :user-pass)) 1 -1)
:header-args:json+: :var s0_hy_host=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :hy-host)) 1 -1)
:header-args:json+: :var s0_vl_host=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :vl-host)) 1 -1)
:header-args:json+: :var s0_short_id=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :short-id)) 1 -1)
:header-args:json+: :var s0_user_uuid=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :user-uuid)) 1 -1)
:header-args:json+: :var s0_any_host=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :any-host)) 1 -1)
:END:
...
:header-args+: :var s0_user_name=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :user-name)) 1 -1)
:header-args+: :var s0_nv_host=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :nv-host)) 1 -1)
:END:

#+header: :var cf_token=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "cf")) :api-token)) 1 -1)
#+header: :var s0_email=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :email)) 1 -1)
#+header: :var s0_masq=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :masq)) 1 -1)
#+header: :var s0_priv_key=(substring (json-serialize (plist-get (cdr (plstore-get zr-local-pls "vps0")) :priv-key)) 1 -1)
#+name: server-config
...
#+begin_src json :tangle (expand-file-name "config.json" "_tangle/naive") :mkdirp t
{
  ...
  "proxy": "quic://$s0_user_name:$s0_user_pass@$s0_nv_host",
  "host-resolver-rules": "MAP $s0_nv_host $s0_ip"
}
#+end_src
