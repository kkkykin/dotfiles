...
#+begin_src conf-unix :var dir=(zr-org-by-tangle-dir "downloads")
...
:END:
#+begin_src conf-unix :var session=(zr-org-by-tangle-dir "aria2.session")
# 从会话文件中读取下载任务
input-file=$session
...
:END:
#+begin_src conf-unix :var dht=(zr-org-by-tangle-dir "dht.dat") 6dht=(zr-org-by-tangle-dir "dht6.dat") tracker=(org-file-contents "https://cf.trackerslist.com/best_aria2.txt")
...
*** misc
:PROPERTIES:
:CUSTOM_ID: 0a6a0edf-5f19-4039-8a18-485a1e9a9b34
:END:
#+begin_src conf-unix :var proxy=(plist-get (cdr (plstore-get zr-local-pls "proxy")) :proxy)
all-proxy=http://$proxy
#+end_src

** SSD or HDD
:PROPERTIES:
:CUSTOM_ID: 50d0912b-79c3-4249-a13d-f5043808b514
:header-args:conf-unix+: :var conf=(zr-org-by-tangle-dir "aria2.conf")
:END:
...
#+begin_src conf-unix :tangle (zr-org-by-tangle-dir "ssd.conf")
file-allocation=none
conf-path=$conf
#+end_src

#+begin_src conf-unix :tangle (zr-org-by-tangle-dir "hdd.conf")
