...
:header-args:python: :shebang (string-join '("#!/usr/bin/env -S uv run -s" "# /// script" "# requires-python = \">=3.12\"" "# [[tool.uv.index]]" "# url = \"https://mirrors.tuna.tsinghua.edu.cn/pypi/web/simple/\"" "# ///") "\n")
